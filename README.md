...
**NOTE**: This is early draft for comment and revision (v0.3) of these specifications.

## Credential Types

Six related credential types and one verifiable data structure are described here:
[Decentralized Trust Graph Credentials](./dtg.md).
